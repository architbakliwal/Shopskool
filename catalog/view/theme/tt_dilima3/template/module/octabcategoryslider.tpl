...
<div class="tabscategory-title">
	<div class="tabscategory-subtitle">
		<div class="tab-title module-title"><h2><?php echo $heading_title2 ?></h2></div>
		<div class="tab-title1 module-title"><h2><?php echo $heading_title3 ?></h2></div>
		<div class="tab-title2 module-title"><h2><?php echo $heading_title ?></h2></div>
		<div class="tab-title3 module-title"><h2><?php echo $heading_title1 ?></h2></div>
