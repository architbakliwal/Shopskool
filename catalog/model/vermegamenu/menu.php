...
//        $html[] = '</a>';
	...
	public function drawCustomMenuItem($category, $level = 0, $last = false, $item, $lang_id,$setting = array()) {
        ...
        $html[] = '<a href="' . $link . '">';
		if(isset($cate['homethumb_image'])) {
            $homethumb_image =  $this->model_tool_image->resize($cate['homethumb_image'], 20,20);
            $html[] = '<img src="'.$homethumb_image.'"  class ="homethumb_image" alt="" />';
        }
